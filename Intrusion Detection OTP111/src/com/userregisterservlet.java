...
public class userregisterservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			ps=con.prepareStatement("insert into usermem_info (name,lastname,dob,gender,email,mobno,username,password)"+"values(?,?,?,?,?,?,?,?)");
			ps.setString(1,name);
			...
			{
				System.out.println("Ragistration failed?success");
			}
		}
