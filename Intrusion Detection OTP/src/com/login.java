...
public class login extends HttpServlet {
			...
			if (rs.next()) 
				{
			     ...
			     //     new LoadForm();
					...
					res.sendRedirect("OTPconfig.jsp?success");
			     
				} 
			else 
				{
				 	out.print("<h1>Sorry, username or password error!</h1>"); 
				 	req.getRequestDispatcher("index.jsp?fail").forward(req, res);
	...
	public void sendotp(String mobileNumbers,String RandNo) throws UnsupportedEncodingException
	{
		 String msgC="OTP for your IIDPS is "+RandNo +" Do not share with anyone.";
