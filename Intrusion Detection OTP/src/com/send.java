            ...
            session = Session.getDefaultInstance(props,
                    new javax.mail.Authenticator() {
                        ...
                        protected PasswordAuthentication getPasswordAuthentication() {
                            return new PasswordAuthentication("myproject3694@gmail.com","projectjava");
                        }
                    });
        
            String From = "surajraje97@gmail.com";
...
private static void addAttachment(Multipart multipart, String filename) throws Exception
{
    ...
    public static void main(String[] args) throws Exception {
            ...
            send s = new send();
            s.EmailSending("surajraje97@gmail.com", "Test", "Test", "H:\\s1.png","H:\\s2.png");
