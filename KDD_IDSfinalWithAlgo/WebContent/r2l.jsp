...
// 			PreparedStatement ps = con.prepareStatement("select * from nsl_kdd_3000 where ");
...
<td><h4>ao&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4></td>
			...
			<% 
			Connection con = DbConnection.getConnection();
 			PreparedStatement ps = con.prepareStatement("select * from features_selection where ao = 'Guesspassword' or ao = 'Ftpwrite' or ao = 'Imap' or ao = 'Phf' or ao = 'Multihop' or ao = 'Warezmaster' or ao = 'Warezclient'");
