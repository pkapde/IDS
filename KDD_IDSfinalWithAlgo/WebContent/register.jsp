...
<body>
	...
	<div id="tooplate_wrapper">
		...
		<div id="tooplate_main_wrapper">
          ...
          <form action="reg" method="post" name="uRegi"  onsubmit="return Regvalidation()">
            <center><table>
            <tr>
            <td><strong>First Name</strong></td><td><input type="text" name="fname" id="fname"></input>&nbsp;&nbsp;&nbsp;</td>
            <td><strong>Middle Name</strong></td><td><input type="text" name="mname" id= "mname"></input>&nbsp;&nbsp;&nbsp;</td>
            <td><strong>Last Name</strong></td><td><input type="text" name="lname" id= "lname"></input>&nbsp;&nbsp;&nbsp;</td>
            </tr>
           ...
           <tr></tr>
            ...
            <td><strong>Mobile no</strong></td><td><input type="text" name="mobile" id="txtMB" onblur="return ValidateMobNumber('txtMB')"></input></td>
            </tr>
            <tr></tr>
            <tr></tr>
            <tr></tr>
            ...
            <td><strong>Password</strong></td><td><input type="password" name="password" id="passwords"></input></td>
            </tr>
