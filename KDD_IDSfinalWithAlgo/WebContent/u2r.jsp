...
<td><h4>ao&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4></td>
			...
			<% 
			Connection con = DbConnection.getConnection();
 			PreparedStatement ps = con.prepareStatement("select * from features_selection where ao = 'Bufferoverflow' or ao = 'LoadModule' or ao = 'Perl' or ao = 'Rootkit'");
